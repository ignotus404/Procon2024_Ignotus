...
namespace _2024ProconTemporary.ReadableData
{
    public class ReadableProblemData
    {
        ...
        public ReadableProblemData(ProblemData problemData)
        {
            ...
            General = new ReadableGeneralData(problemData.General.N, problemData.General.Patterns.Select(p => new ReadablePatternData(p.P, p.Width, p.Height, p.Cells)).ToList());
        }
    ...
    public class ReadableBoardData
    {
        ...
        public List<List<int>> Start { get; set; }
        public List<List<int>> Goal { get; set; }
    ...
    public class ReadablePatternData
    {
        ...
        public ReadablePatternData(int p, int width, int height, IList<List<int>> cells)
        {
            P = p;
            Width = width;
            Height = height;
